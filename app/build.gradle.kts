...
android {
    ...
    defaultConfig {
        ...
        // targetSdk 36); D-120 the Circadian "Use current location" button actively acquires (fresh fix →
        // ipwho.is IP fallback when opted in) instead of echoing another app's last-known fix; D-121 the
