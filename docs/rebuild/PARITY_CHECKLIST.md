...
| AAB Experiment Settings | L3334 | Circadian (renamed S12.6a/G2R-F4) | ported (S12.5b — scaling/taper + taper-midpoint slider 130–240 (G2-F13) + warnings; chart slot S13; **S12.7h**: fixed Date+Lat/Lon preview element (`_ExperimentSetDate`/`_ExperimentClearDate`, elements35–37) defaulting to today + current location, `ExperimentPrefsStore`, G2R-F39) |
