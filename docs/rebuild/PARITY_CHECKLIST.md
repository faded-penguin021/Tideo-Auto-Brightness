...
| Software/super dimming math: 700, 645, 646, 647 | | SoftwareDimming.kt (S5 math); 650/653/654/644 privilege writes platform (S9b) | ported (math) |
| Initial brightness on wake: 618 | | TaskerReference (S4) + InitialBrightness.kt (S5) | ported |
| Hibernate/reset: 585 | | | pending |
| Throttle reset: 566 | | | pending |
| Manual override detect/resume: 567, 569, 561, 640, 641, 636 | | OverrideRules.kt (S5 pure logic); platform wiring + notification S9a | ported (logic) |
