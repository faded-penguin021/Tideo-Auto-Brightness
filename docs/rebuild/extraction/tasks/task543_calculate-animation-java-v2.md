...
- **XML:** `Advanced_Auto_Brightness_V3.3.prj_9.xml` lines L15871–L15928 (58 lines)
...
|---|---|---|---|---|
| 0 | L15877 | 474 Java Code | **Java Code** → `` (see `_source/java/task543_*.java.txt`) |  |
| 1 | L15920 | 126 Return | **Return** `%loops,%wait` |  |
