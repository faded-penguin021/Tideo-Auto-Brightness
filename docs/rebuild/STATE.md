...
all provenance preserved, no behaviour change, D-076). NEXT: S12.9f — Profiles & Contexts IA merge (fold the two
destinations into one screen + a rule-editing modal; plumbing only, S13 restyles; RUNBOOK §S12.9f, D-070).** S12.9 lands repo hygiene
...
Append new entries as D-077, … with which segments they affect.
