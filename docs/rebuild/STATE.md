...
- **G2R-F71 (owner, 2026-06-15 — DEFERRED, future session)** **Reactivity cooldown is fixed to
...
- **G2R-F72 (owner, 2026-06-15 — DEFERRED, future session)** **Cannot remove a time rule from a context.**
